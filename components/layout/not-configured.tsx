      ...
      <div className="panel w-full max-w-md p-8 text-center">
        ...
        <ol className="mt-4 space-y-1.5 text-left text-[13px] text-ink-faint">
          ...
          <li>
            ...
            <code className="rounded bg-canvas-inset px-1 py-0.5 text-ink-soft">
              supabase/migrations
            </code>{" "}
            в SQL-редакторе
          </li>
          <li>
            3. Заполните <code className="rounded bg-canvas-inset px-1 py-0.5 text-ink-soft">.env.local</code>:
